...
_G.packer_plugins = {
  ...
  ["flutter-tools.nvim"] = {
    loaded = true,
    path = "/home/chris/.local/share/nvim/site/pack/packer/start/flutter-tools.nvim",
  ...
  ["lsp_lines.nvim"] = {
    ...
    loaded = true,
    path = "/home/chris/.local/share/nvim/site/pack/packer/start/lsp_lines.nvim",
  ...
  ["nvim-dap-virtual-text"] = {
    loaded = true,
    path = "/home/chris/.local/share/nvim/site/pack/packer/start/nvim-dap-virtual-text",
